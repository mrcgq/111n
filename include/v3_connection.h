...
typedef enum v3_conn_state_e {
    V3_CONN_STATE_IDLE = 0,         /* 空闲 */
    V3_CONN_STATE_CONNECTING,       /* 连接中 */
    V3_CONN_STATE_HANDSHAKING,      /* 握手中 */
    V3_CONN_STATE_ESTABLISHED,      /* 已建立 */
    V3_CONN_STATE_CLOSING,          /* 关闭中 */
    V3_CONN_STATE_CLOSED,           /* 已关闭 */
    V3_CONN_STATE_ERROR,            /* 错误 */
    V3_CONN_STATE_TIMEOUT,          /* 超时 */
} v3_conn_state_t;
